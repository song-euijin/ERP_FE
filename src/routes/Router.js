...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: "/Admin/UserManage/UserList", exact: true, element: <UserList /> },
      { path: "/Admin/UserManage/UserReg", exact: true, element: <UserReg /> },
      { path: "/Admin/UserManage/UserInfo", exact: true, element: <UserInfo /> },
